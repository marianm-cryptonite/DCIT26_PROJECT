        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <a href="add_staff.php" class="btn btn-outline-success"><i class="fas fa-user-plus"></i>New Employee</a>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $staff->staff_nationality; ?></td>
                      <td><?php echo $staff->staff_status; ?></td>
                      <td><?php echo $staff->staff_depart; ?></td>
                      <td><?php echo $staff->staff_empstatus; ?></td>
                      <td>
