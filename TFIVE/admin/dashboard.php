  ...
  <div class="main-content">
    ...
    <div style="background-image: url(assets/img/theme/restro00.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">php<?php echo $sales; ?></span>
                    </div>
                    <div class="col-auto">
     ...
     <div class="container-fluid mt--7">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                  <th class="text-success" scope="col"><b>Employee Name</b></th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <th class="text-success" scope="row"><?php echo $order->customer_name; ?></th>
                      <td><?php echo $order->order_code; ?></td>
                      <td class="text-success"><?php echo $order->prod_name; ?></td>
                      <td>php<?php echo $order->prod_price; ?></td>
      ...
      </div>     <?php require_once('partials/_footer.php'); ?>
    </div>
  </div>
